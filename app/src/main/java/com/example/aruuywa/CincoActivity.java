...
public class CincoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r1=sp1.load(getApplicationContext(), R.raw.gallo_s, 1);
        sp2=new SoundPool(9, AudioManager.STREAM_MUSIC,0);
        r2=sp2.load(getApplicationContext(), R.raw.gallo, 1);
    }
    ...
    public void siguiente(View v){
        Intent i = new Intent(CincoActivity.this,SeisActivity.class);

        startActivity(i);

    }
    public void anterior(View v){
        Intent i = new Intent(CincoActivity.this,CuatroActivity.class);
