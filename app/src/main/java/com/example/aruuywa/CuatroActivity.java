...
public class CuatroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r1=sp1.load(getApplicationContext(), R.raw.gallina_s, 1);
        sp2=new SoundPool(9, AudioManager.STREAM_MUSIC,0);
        r2=sp2.load(getApplicationContext(), R.raw.gallina, 1);
    }
    ...
    public void siguiente(View v){
        Intent i = new Intent(CuatroActivity.this,CincoActivity.class);

        startActivity(i);

    }
    public void anterior(View v){
        Intent i = new Intent(CuatroActivity.this,TresActivity.class);
