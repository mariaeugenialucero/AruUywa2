...
public class SeisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r1=sp1.load(getApplicationContext(), R.raw.llama_s, 1);
        sp2=new SoundPool(9, AudioManager.STREAM_MUSIC,0);
        r2=sp2.load(getApplicationContext(), R.raw.llama, 1);
    }
    ...
    public void siguiente(View v){
        Intent i = new Intent(SeisActivity.this,SieteActivity.class);

        startActivity(i);

    }
    public void anterior(View v){
        Intent i = new Intent(SeisActivity.this,CincoActivity.class);
