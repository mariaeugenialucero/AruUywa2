...
public class TresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r1=sp1.load(getApplicationContext(), R.raw.chancho_s, 1);
        sp2=new SoundPool(9, AudioManager.STREAM_MUSIC,0);
        r2=sp2.load(getApplicationContext(), R.raw.chancho, 1);
    }
    ...
    public void anterior(View v){
        Intent i = new Intent(TresActivity.this,DosActivity.class);
